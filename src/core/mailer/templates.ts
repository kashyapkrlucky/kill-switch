...
const COMMON_STYLES = `
    <style>
        ...
        .header { background: linear-gradient(135deg, #33eab6ff 0%, #098e6bff 50%, #09d55eff 100%); padding: 40px 30px; text-align: center; }
        ...
        .cta-button { display: inline-block; background: linear-gradient(135deg, #33eab6ff 0%, #098e6bff 50%, #09d55eff 100%); color: white !important; text-decoration: none; padding: 16px 32px; border-radius: 16px; font-weight: 600; box-shadow: 0 8px 20px rgba(51, 234, 182, 0.3); }
    ...
    <div class="container">
        ...
        <div class="content">
            <p style="text-align: center; margin-bottom: 30px;">
                <a href=${NEXT_PUBLIC_APP_URL}/dashboard class="cta-button">Create your first project</a>
            </p>
        </div>
        <div class="footer">
            <p>${COPYRIGHT}</p>
