...
import { IDBProfile } from "@/core/types/database.types";

const profileSchema = new Schema<IDBProfile>(
  {
    user: {
...
export const Profile = mongoose.models.Profile || model<IDBProfile>("Profile", profileSchema);
