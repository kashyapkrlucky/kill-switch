      ...
      <div className="mb-8">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div>
            ...
            <p className="text-gray-400">Manage your projects and their settings</p>
          </div>
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl overflow-hidden">
          ...
          <div className="grid grid-cols-12 gap-4 p-4 bg-slate-900/50 border-b border-slate-700">
            <div className="col-span-3">
              <h4 className="text-sm font-semibold text-gray-400 uppercase tracking-wider">Project Name</h4>
            </div>
            ...
            <div className="col-span-2">
              <h4 className="text-sm font-semibold text-gray-400 uppercase tracking-wider">Members</h4>
            </div>
            ...
            {projects.map((project) => (
              ...
              >
                ...
                <div className="col-span-2">
                  ...
                  >
                    {project.status === 'active' ? '● Active' : project.status === 'inactive' ? '● Inactive' : '● Completed'}
                  </span>
                </div>
