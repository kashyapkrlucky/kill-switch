...
const variantClasses = {
  ...
  outline: "border border-gray-500 bg-transparent text-gray-300 hover:bg-gray-800 hover:text-white focus:ring-2 focus:ring-gray-500",
  ghost: "border-transparent bg-transparent text-gray-300 hover:bg-gray-800 hover:text-white focus:ring-2 focus:ring-gray-500",
